...
<section class="text-gray-400 bg-gray-900 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 class="title-font font-medium text-3xl text-white">Table-tennis Registration Portal</h1>
    ...
    <div class="lg:w-2/6 md:w-1/2 bg-gray-800 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      <h2 class="text-white text-lg font-medium title-font mb-5">Table-tennis Registration</h2>
      <form action="tt_reg.php" method="post">
...
$max_parp= $_SESSION['max_parp'];
// $max_b= $_SESSION['no_play_b'];
$real_name=$_SESSION['player_name'];
echo $max_parp;
echo $real_name;

$sql1="SELECT * FROM tt_reg";
$result=$conn1->query($sql1);
$flag3=true;
if ($result->num_rows > 0)
{
  if(mysqli_num_rows($result)<(int)($max_parp))
  {
    $flag3=true;
  }
  else{
