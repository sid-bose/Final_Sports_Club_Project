...
<body>
    ...
    $sql="SELECT Name ,username from registration_details";
    ...
    echo"<br/>";
    // echo "<a href='logout_m.php' class='logout'>Logout</a>";
    // $conn->close();
    ?>
  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap">
      ...
      <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
        ...
        <p class="leading-relaxed text-base mb-4"></p>
        <a href="tournament_m.php" class="text-indigo-400 inline-flex items-center">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
      ...
      <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
        ...
        <p class="leading-relaxed text-base mb-4"></p>
        <a href="support_m.php" class="text-indigo-400 inline-flex items-center">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
    ...
    <form action="logout_m.php" method="post">
